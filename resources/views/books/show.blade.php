...
@section('content')
    <div class="container mx-auto py-12 px-4 max-w-4xl">
        ...
        <div class="mb-8 text-right">
            <a href="{{ route('books.reviewForm', $book->id) }}" class="bg-blue-600 text-black py-2 px-4 rounded-lg hover:bg-blue-700 transition">
                📝 Donner un avis
            </a>
            
        </div>
<p><a href="{{ url()->previous() }}" class="btn btn-primary">← Retour à la page precedente</a></p>
